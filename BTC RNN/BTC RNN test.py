...
df_test = pd.read_csv('C:/Users/User/Desktop/RNNLSTM/BTC RNN/data/BTC_USDT_Test_2020-01-01_to_2020-04-30_4h.csv')
...
model = load_model('C:/Users/User/Desktop/RNNLSTM/BTC RNN/data/Train_data/bitcoin_RNN_model' + str(look_back) + '.keras')
...
plt.title("2020 April Bitcoin Price: Real vs Predicted (RNN) with Moving Averages")
plt.xlabel("Time")
